...
export const getGlobalData = cache(async (): Promise<GlobalData> => {
  try {
    ...
    return {
      ...
      contactAddress: d?.contactAddress ?? "4/801, Rangoli Greens, Panchyawala, Jaipur",
      contactPhone: d?.contactPhone ?? "+91 96020 97198",
      contactEmail: d?.contactEmail ?? "Sales@quantprocure.com",
    ...
    return {
      ...
      contactAddress: "4/801, Rangoli Greens, Panchyawala, Jaipur",
      contactPhone: "+91 96020 97198",
      contactEmail: "Sales@quantprocure.com",
