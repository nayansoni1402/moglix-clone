...
const Error = () => {
  return (
    <>
      ...
      <section className="overflow-hidden pt-2 pb-10 sm:pb-20 bg-[#F4F5F9]" style={{ backgroundColor: "#F4F5F9" }}>
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="bg-white rounded-xl shadow-sm border border-gray-3 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[450px] text-sm text-dark-3 w-full mx-auto mb-8">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 font-bold text-white bg-blue py-3 px-8 rounded-lg transition-all duration-300 hover:bg-blue-dark shadow-sm hover:shadow-md"
              >
                <svg
